...
const Contact = () => {
  const contactInfo = [
    {
      ...
      label: "Email",
      value: "shreyatpathi2005@gmail.com",
      link: "mailto:shreyatpathi2005@gmail.com",
    },
    {
  ...
  const socialLinks = [
    {
      ...
      label: "GitHub",
      link: "https://github.com/Shreya2456",
    },
    {
      icon: <Linkedin className="w-5 h-5" />,
      label: "LinkedIn",
      link: "https://www.linkedin.com/in/Shreyatripathi26/",
    },
  ];
  ...
  const sendMailFallback = () => {
    ...
    window.location.href = `mailto:shreyatpathi2005@gmail.com?subject=${subject}&body=${body}`;
  };
